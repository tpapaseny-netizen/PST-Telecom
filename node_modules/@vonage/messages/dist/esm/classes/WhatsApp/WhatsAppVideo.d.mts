import { AbstractVideoMessage } from '../AbstractVideoMessage.mjs';
import { Channels } from '../../enums/Channels.mjs';
import { WhatsAppContext } from '../../types/Channels/WhatsApp/WhatsAppParams.mjs';
import { WhatsAppVideoParams } from '../../types/Channels/WhatsApp/WhatsAppVideoParams.mjs';
 ...
 * @group WhatsApp
 */
declare class WhatsAppVideo extends AbstractVideoMessage implements WhatsAppVideoParams {
    /**
     ...
     * ```
     */
    constructor(params: Omit<WhatsAppVideoParams, 'channel' | 'messageType'>);
}

export { WhatsAppVideo };
