...
// lib/enums/ArchiveOutputMode.ts
var ArchiveOutputMode = /* @__PURE__ */ ((ArchiveOutputMode2) => {
  ArchiveOutputMode2["COMPOSED"] = "composed";
  ArchiveOutputMode2["INDIVIDUAL"] = "individual";
  return ArchiveOutputMode2;
})(ArchiveOutputMode || {});

// lib/enums/AudioRate.ts
var AudioRate = /* @__PURE__ */ ((AudioRate2) => {
  AudioRate2[AudioRate2["16KHZ"] = 16e3] = "16KHZ";
  AudioRate2[AudioRate2["8KHZ"] = 8e3] = "8KHZ";
  return AudioRate2;
})(AudioRate || {});

// lib/enums/CaptionStatus.ts
var CaptionStatus = /* @__PURE__ */ ((CaptionStatus2) => {
  CaptionStatus2["STARTED"] = "started";
  CaptionStatus2["STOPPED"] = "stopped";
  CaptionStatus2["PAUSED"] = "paused";
  CaptionStatus2["FAILED"] = "failed";
  return CaptionStatus2;
})(CaptionStatus || {});

// lib/enums/Resolution.ts
var Resolution = /* @__PURE__ */ ((Resolution2) => {
  Resolution2["FHD_LANDSCAPE"] = "1920x1080";
  Resolution2["FHD_PORTRAIT"] = "1080x1920";
  Resolution2["HD_LANDSCAPE"] = "1280x720";
  Resolution2["HD_PORTRAIT"] = "720x1280";
  Resolution2["SD_LANDSCAPE"] = "640x480";
  Resolution2["SD_PORTRAIT"] = "480x640";
  return Resolution2;
})(Resolution || {});
...
// lib/enums/StreamMode.ts
var StreamMode = /* @__PURE__ */ ((StreamMode2) => {
  StreamMode2["AUTO"] = "auto";
  StreamMode2["MANUAL"] = "manual";
  return StreamMode2;
})(StreamMode || {});

// lib/enums/MediaMode.ts
var MediaMode = /* @__PURE__ */ ((MediaMode2) => {
  MediaMode2["ROUTED"] = "disabled";
  MediaMode2["RELAYED"] = "enabled";
  return MediaMode2;
})(MediaMode || {});

// lib/types/ArchiveMode.ts
var ArchiveMode = /* @__PURE__ */ ((ArchiveMode2) => {
  ArchiveMode2["MANUAL"] = "manual";
  ArchiveMode2["ALWAYS"] = "always";
  return ArchiveMode2;
})(ArchiveMode || {});
...
var Video = class extends import_server_client.Client {
  ...
  async createSession(sessionOptions) {
    const data = {
      archiveMode: sessionOptions?.archiveMode ?? "manual" /* MANUAL */,
      "p2p.preference": sessionOptions?.mediaMode ?? "disabled" /* ROUTED */,
  ...
  generateClientToken(sessionId, tokenOptions) {
    ...
    return (0, import_jwt.tokenGenerate)(
   ...
   * ```
   */
  async initiateSIPCall(sessionId, options) {
