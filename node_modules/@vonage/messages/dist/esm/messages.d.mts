...
import { UpdateMessageParams } from './types/UpdateMessageParams.mjs';
...
declare class Messages extends Client {
     ...
     */
    updateMessage(messageId: string, status: UpdateMessageStatus | string, params: UpdateMessageParams): Promise<true>;
}
