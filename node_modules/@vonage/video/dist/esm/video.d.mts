...
import { MediaMode } from './enums/MediaMode.mjs';
import { ArchiveLayout } from './types/ArchiveLayout.mjs';
import { ArchiveMode } from './types/ArchiveMode.mjs';
import { ArchiveOptions } from './types/ArchiveOptions.mjs';
import { ArchiveSearchFilter } from './types/ArchiveSearchFilter.mjs';
import { BroadcastConfig } from './types/BroadcastConfig.mjs';
import { BroadcastSearchFilter } from './types/BroadcastSearchFilter.mjs';
import { BroadcastUpdateConfig } from './types/BroadcastUpdateConfig.mjs';
import { CaptionOptions } from './types/CaptionOptions.mjs';
import { ClientTokenOptions } from './types/ClientTokenOptions.mjs';
import { ExperienceComposerListFilter } from './types/ExperienceComposerListFilter.mjs';
import { ExperienceComposerOptions } from './types/ExperienceComposerOptions.mjs';
import { BroadcastDetailsResponse } from './types/Response/BroadcastDetailsResponse.mjs';
import { CaptionStatusResponse } from './types/Response/CaptionStatusResponse.mjs';
import { EnableCaptionResponse } from './types/Response/EnableCaptionResponse.mjs';
import { ExperienceComposerResponse } from './types/Response/ExperienceComposerResponse.mjs';
import { MultiArchiveResponse } from './types/Response/MultiArchiveResponse.mjs';
import { MultiBroadcastResponse } from './types/Response/MultiBroadcastResponse.mjs';
import { MultiExperienceComposerResponse } from './types/Response/MultiExperienceComposerResponse.mjs';
import { MultiStreamLayoutResponse } from './types/Response/MultiStreamLayoutResponse.mjs';
import { ProjectDetailsResponse } from './types/Response/ProjectDetailsResponse.mjs';
import { SingleArchiveResponseBase, SingleArchiveResponse } from './types/Response/SingleArchiveResponse.mjs';
import { SingleStreamLayoutResponse } from './types/Response/SingleStreamLayoutResponse.mjs';
import { SIPCallResponse } from './types/Response/SIPCallResponse.mjs';
import { WebSocketConnectResponse } from './types/Response/WebSocketConnectResponse.mjs';
import { SIPCallOptions } from './types/SIPCallOptions.mjs';
import { Session } from './types/Session.mjs';
import { Signal } from './types/Singal.mjs';
import { StreamClassList } from './types/StreamClassList.mjs';
import { WebSocketConfig } from './types/WebSocketConfig.mjs';
import './enums/LayoutType.mjs';
import './enums/ArchiveOutputMode.mjs';
import './enums/Resolution.mjs';
import './enums/StreamMode.mjs';
import './types/RTMPStream.mjs';
import './enums/ExperienceComposerResolution.mjs';
import './enums/CaptionStatus.mjs';
import './enums/AudioRate.mjs';
 ...
 * ```
 */
declare class Video extends Client {
     ...
     * ```
     */
    initiateSIPCall(sessionId: string, options: SIPCallOptions): Promise<SIPCallResponse>;
    /**
