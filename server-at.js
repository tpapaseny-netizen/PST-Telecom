...
<style>
  *, *::before, *::after { box-sizing: border-box; }
  ...
  body { margin:0; font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial; background:#F2ECDD; min-height:100vh; padding:22px 16px; color:#1A1A1A; width:100%; }
  ...
  .card { background:rgba(26,26,26,.12); border:1px solid rgba(26,26,26,.2); border-radius:16px; padding:14px; margin-bottom:12px; width:100%; backdrop-filter:blur(6px); }
  ...
  input[type=number] { flex:1 1 auto; min-width:0; width:100%; background:rgba(26,26,26,.15); border:none; border-radius:10px; padding:11px; color:#1A1A1A; font-size:18px; font-weight:700; outline:none; }
  .curr-btn { flex:0 0 auto; min-width:0; max-width:42%; background:rgba(26,26,26,.22); border:1px solid rgba(26,26,26,.28); border-radius:10px; padding:11px 10px; color:#1A1A1A; font-weight:800; font-size:13px; cursor:pointer; display:flex; align-items:center; justify-content:center; gap:5px; white-space:nowrap; transition:background .15s; }
  .curr-btn:active { background:rgba(26,26,26,.32); }
  ...
  button.act { width:100%; margin-top:8px; padding:12px; border:none; border-radius:12px; background:rgba(26,26,26,.18); color:#1A1A1A; font-weight:700; font-size:13px; cursor:pointer; transition:background .15s; }
  button.act:active { background:rgba(26,26,26,.28); }
  ...
  .picker-flag { width:34px; height:34px; border-radius:10px; background:#1A1A1A; display:flex; align-items:center; justify-content:center; font-size:15px; font-weight:800; color:#F2ECDD; flex-shrink:0; }
  ...
  .picker-opt.sel .picker-check { border-color:#1A1A1A; }
  .picker-opt.sel .picker-check::after { content:''; position:absolute; inset:3px; border-radius:50%; background:#1A1A1A; }
</style>
</head>
<body>
  ...
  <div style="display:flex;align-items:center;justify-content:center;gap:7px;margin-top:16px;padding:0 4px;"><img src="data:image/png;base64," alt="Penc" style="width:20px;height:20px;object-fit:contain;opacity:.85;"/><span style="font-size:10px;color:rgba(26,26,26,.55);">Mini-programme Penc — bac à sable, sans accès à vos conversations</span></div>
...
<style>
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .card { background:rgba(26,26,26,.12); border:1px solid rgba(26,26,26,.2); border-radius:16px; padding:14px; margin-bottom:12px; width:100%; }
  ...
  input[type=number] { width:100%; background:rgba(26,26,26,.15); border:none; border-radius:10px; padding:11px; color:#1A1A1A; font-size:17px; font-weight:700; outline:none; min-width:0; }
  .field { margin-bottom:12px; }
  .field:last-child { margin-bottom:0; }
  .result-card { background:rgba(26,26,26,.16); border:1px solid rgba(26,26,26,.28); border-radius:16px; padding:18px; text-align:center; margin-bottom:12px; }
  ...
  button.act { width:100%; margin-top:4px; padding:12px; border:none; border-radius:12px; background:rgba(26,26,26,.18); color:#1A1A1A; font-weight:700; font-size:13px; cursor:pointer; }
...
<body>
  ...
  <button class="act" onclick="shareResult()">📤 Partager le résultat</button>
  <div style="text-align:center;font-size:10px;color:rgba(26,26,26,.6);margin-top:16px;padding:0 4px;line-height:1.5;">Nisab de référence : ≈ 595 g d'argent. Le seuil exact varie selon le cours du marché — vérifie une source à jour avant de finaliser ton calcul.</div><div style="display:flex;align-items:center;justify-content:center;gap:7px;margin-top:10px;"><img src="data:image/png;base64," alt="Penc" style="width:20px;height:20px;object-fit:contain;opacity:.85;"/><span style="font-size:10px;color:rgba(26,26,26,.55);">Mini-programme Penc — bac à sable, sans accès à tes conversations</span></div>
...
async function _postEnrichMany(rows, meId){
  ...
  function one(row, withRepost){
    ...
    const o = {
      ...
      author_verified: a ? !!(a.verified || a.business_verified) : false,
      content: row.content || '',
      media_urls: media,
      bg: row.bg || null,
...
async function _filRankedFeed(uid, visible){
  ...
  let pool = (await _pgPool.query("SELECT * FROM penc_posts WHERE deleted=FALSE AND created_at > NOW() - INTERVAL '30 days' ORDER BY created_at DESC LIMIT 500")).rows;
  if(pool.length < 60){ pool = (await _pgPool.query('SELECT * FROM penc_posts WHERE deleted=FALSE ORDER BY created_at DESC LIMIT 200')).rows; }
...
app.get('/api/penc/posts/:id', pencAuth, async (req, res) => {
  try{
    if(!_pgPool) return res.status(503).json({ error: 'Indisponible' });
    const uid = req.pencUser.userId;
    const r = await _pgPool.query('SELECT * FROM penc_posts WHERE id=$1 AND deleted=FALSE',[req.params.id]);
...
app.get('/api/penc/posts/:id/stats', pencAuth, async (req, res) => {
  try{
    ...
    if(!p.rows.length) return res.status(404).json({ error: 'Introuvable' });
    if(String(p.rows[0].user_id) !== String(uid) && !req.pencUser.is_admin) return res.status(403).json({ error: 'Non autorisé' });
...
app.delete('/api/penc/posts/comments/:cid', pencAuth, async (req, res) => {
  try{
    ...
    const row = c.rows[0];
    if(String(row.user_id)!==String(uid) && String(row.owner)!==String(uid) && !req.pencUser.is_admin) return res.status(403).json({ error: 'Non autorisé' });
...
app.get('/api/penc/fil/profile/:id', pencAuth, async (req, res) => {
  try{
    ...
    const posts_count = await one('SELECT COUNT(*)::int AS n FROM penc_posts WHERE user_id=$1 AND deleted=FALSE',[target]);
...
app.get('/api/penc/fil/search', pencAuth, async (req, res) => {
  try{
    ...
    const pr = await _pgPool.query('SELECT * FROM penc_posts WHERE deleted=FALSE AND content ILIKE $1 ORDER BY created_at DESC LIMIT 40',[like]);
